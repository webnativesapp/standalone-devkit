...
LocalFileSystem.prototype.getDevkitTemplatePath = function (template) {
    ...
    switch (template) {
        case AVAILABLE_TEMPLATES.EMPTY:
            templateName = 'template-blank';
            break;
        case AVAILABLE_TEMPLATES.BABYLONJS:
            templateName = 'template-babylonjs';
            break;
        case AVAILABLE_TEMPLATES.TIMESTEP:
            templateName = 'template-gameclosure';
            break;
        case AVAILABLE_TEMPLATES.PIXIJS:
            templateName = 'template-pixijs';
            break;
        case AVAILABLE_TEMPLATES.PHASER:
            templateName = 'template-phaser';
            break;
        case AVAILABLE_TEMPLATES.THREEJS:
            templateName = 'template-threejs';
            break;
        case AVAILABLE_TEMPLATES.PLAYCANVAS:
            templateName = 'template-playcanvas';
            break;
        case AVAILABLE_TEMPLATES.BOOTSTRAP:
            templateName = 'template-bootstrap';
            break;
        case AVAILABLE_TEMPLATES.REACT:
            templateName = 'template-reactjs';
            break;
        default:
            templateName = 'template-blank';
            break;
