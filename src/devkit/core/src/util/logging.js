...
exports.Logger = Class(Writable, function () {
  ...
  this.info =
  this.log = function () {
    console.info.apply(console, [this._prefix].concat(Array.prototype.map.call(arguments, this.format, this)));
  }

  this.warn = function () {
    console.info.apply(console, [this._prefix, color.redBright('[warn] ')].concat(Array.prototype.map.call(arguments, this.format, this)));
  }

  this.error = function () {
    console.info.apply(console, [this._prefix, color.redBright('[error] ')].concat(Array.prototype.map.call(arguments, this.format, this)));
  }
